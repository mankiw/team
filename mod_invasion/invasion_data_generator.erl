...
generate()	->
	FunDatas1	= generate_invasion_info(get_invasion_info),
	FunDatas2	= generate_init_copy_list(init_copy_list),
	FunDatas3	= generate_get_copy_list(get_copy_list),
	FunDatas4	= generate_map2copy(map2copy),
	FunDatas5	= generate_map_list(get_map_list),
	FunDatas6	= generate_invasion_gift(get_invasion_gift),
	FunDatas7	= generate_attack_to_guard(attack_to_guard),
	FunDatas8	= generate_invasion_doll_reward(get_invasion_doll_reward),
...
generate_invasion_info(FunName)	->
	Datas	= 
...
%% 副本列表
generate_init_copy_list(FunName)	->
	Datas	=
		case misc_app:load_file(?DIR_YRL_ROOT ++ "invasion/invasion.yrl") of
			Data when is_list(Data)	->
				Data;
...
%% 副本列表
generate_get_copy_list(FunName) ->
	Datas	=
		case misc_app:load_file(?DIR_YRL_ROOT ++ "invasion/invasion.yrl") of
			Data when is_list(Data)	->
				Data;
...
generate_invasion_gift(FunName)	->
	Datas	= 
		case misc_app:load_file(?DIR_YRL_ROOT ++ "invasion/invasion.gift.yrl") of
			Data when is_list(Data)	->
				Data;
			Data	->
				[Data]
...
generate_attack_to_guard(FunName)	->
	Datas	= 
		case misc_app:load_file(?DIR_YRL_ROOT ++ "invasion/invasion.yrl") of
			Data when is_list(Data)	->
				Data;
...
generate_invasion_doll_reward(FunName)	->
	Datas	= 
		case misc_app:load_file(?DIR_YRL_ROOT ++ "invasion/invasion.doll.yrl") of
			Data when is_list(Data)	->
				Data;
			Data	->
				[Data]
